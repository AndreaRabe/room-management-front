    ...
    return(
        <div>
                <div className="form-singin-div-1-checkbox-admin">
                    <span style={{}} className={!admin ? 'active': ''} onClick={handleTabClick}>Client</span>
                    <span style={{}} className={admin ? 'active': ''} onClick={handleTabClick}>Mes reservations</span>
                </div>
...
function ClientListReservation(){
    ...
    setReservations(updatedReservations);
      ...
      const sortedReservations = [...filteredReservations].sort((a, b) => {
        // Check if the reservation is viewed or not
        const isViewedA = a.view;
        const isViewedB = b.view;
      
        // Compare viewed status
        if (isViewedA !== isViewedB) {
          // Sort viewed reservations first (reversed order)
          return isViewedA ? -1 : 1;
        }
      
        // If both reservations are either viewed or non-viewed, then proceed with regular sorting
        if (sortConfig.key && a[sortConfig.key] && b[sortConfig.key]) {
          if (a[sortConfig.key] < b[sortConfig.key]) {
            return sortConfig.direction === 'ascending' ? 1 : -1; // Reverse the order here
          }
          if (a[sortConfig.key] > b[sortConfig.key]) {
            return sortConfig.direction === 'ascending' ? -1 : 1; // Reverse the order here
          }
      ...
      const [reservations, setReservations] = useState([
        {
            ...
            nombre_participant: 15,
            lieu_salle: "Salle A",
            specification: "Réunion matinale avec présentation",
          },
          {
            view: true,
            heure_debut: "14:30",
            ...
            nombre_participant: 10,
            lieu_salle: "Salle B",
            specification: "Formation sur les nouvelles fonctionnalités",
          },
          {
            view: true,
            heure_debut: "10:00",
            ...
            nombre_participant: 20,
            lieu_salle: "Salle C",
            specification: "Réunion stratégique de l'équipe",
          },
          {
            view: true,
            heure_debut: "13:30",
            ...
            nombre_participant: 18,
            lieu_salle: "Salle A",
            specification: "Discussion sur les objectifs trimestriels",
          },
          {
            view: true,
            heure_debut: "15:00",
            ...
            nombre_participant: 12,
            lieu_salle: "Salle B",
            specification: "Présentation des résultats financiers",
          },
          {
            view: true,
            heure_debut: "11:30",
            ...
            nombre_participant: 8,
            lieu_salle: "Salle C",
            specification: "Réunion informelle avec déjeuner",
          },
          {
            view: true,
            heure_debut: "16:30",
            ...
            nombre_participant: 25,
            lieu_salle: "Salle A",
            specification: "Séance de brainstorming sur les projets futurs",
          },
          {
            view: true,
            heure_debut: "12:00",
            ...
            nombre_participant: 22,
            lieu_salle: "Salle B",
            specification: "Réunion client avec démo produit",
          },
          {
            view: true,
            heure_debut: "08:30",
            ...
            nombre_participant: 30,
            lieu_salle: "Salle C",
            specification: "Conférence sur les nouvelles tendances de l'industrie",
          },
          {
            view: true,
            heure_debut: "13:00",
            ...
            nombre_participant: 12,
            lieu_salle: "Salle A",
            specification: "Réunion virtuelle avec des partenaires internationaux",
          },
      ])
...
function ViewReservation({ reservation, onClose }) {
    useEffect(() => {
        if (reservation) {
          document.body.classList.add('no-scroll')
        } else {
    ...
    if (reservation){
        const {
          ...
          return (
            <div className="custom-dialog-overlay-view" >
                <div className="custom-dialog-view">
                    <h2>Informations de la réservation</h2>
                    <p>Lieu : {lieu_salle}</p>
                    <p>Date : {date_reservation}</p>
                    <p>Heure de début : {heure_debut}</p>
                    <p>Heure de fin : {heure_fin}</p>
                    <p>Nombre de participants : {nombre_participant}</p>
                    <p>Spécification : {specification}</p>
